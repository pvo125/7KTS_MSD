...
#define SDIO_CMD0TIMEOUT                ((u32)0x00010000)//((u32)0x00002710)
...
* Return         : SD_Error: SD Card Error code.
*******************************************************************************/
SD_Error SD_ReadBlock(u32 addr, uint8_t *readbuff, u16 BlockSize)
{
  SD_Error errorstatus = SD_OK;
  u32 count = 0, *tempbuff = (uint32_t*)readbuff;
  u8 power = 0;
...
* Return         : SD_Error: SD Card Error code.
*******************************************************************************/
SD_Error SD_ReadMultiBlocks(u32 addr, uint8_t *readbuff, u16 BlockSize, u32 NumberOfBlocks)
{
  SD_Error errorstatus = SD_OK;
  u32 count = 0, *tempbuff = (uint32_t*)readbuff;
  u8 power = 0;
...
* Return         : SD_Error: SD Card Error code.
*******************************************************************************/
SD_Error SD_WriteBlock(u32 addr, uint8_t *writebuff, u16 BlockSize)
{
  SD_Error errorstatus = SD_OK;
  u8  power = 0, cardstate = 0;
  u32 timeout = 0, bytestransferred = 0;
  u32 cardstatus = 0, count = 0, restwords = 0;
  u32 *tempbuff = (uint32_t*)writebuff;
...
* Return         : SD_Error: SD Card Error code.
*******************************************************************************/
SD_Error SD_WriteMultiBlocks(u32 addr, uint8_t *writebuff, u16 BlockSize, u32 NumberOfBlocks)
{
  SD_Error errorstatus = SD_OK;
  u8  power = 0, cardstate = 0;
...
// 	 SDIO_D0    PC8				Alternate function push-pull
//	 SDIO_D1		PC9				Alternate function push-pull
//	 SDIO_D2		PC10			Alternate function push-pull
//	 SDIO_D3		PC11			Alternate function push-pull
//	 SDIO_CK		PC12			Alternate function push-pull					
...
//		SDIO_CMD		PD2			Alternate function push-pull
